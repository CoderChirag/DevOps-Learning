...
- [VProfile Project Setup (Local)](#vprofile-project-setup-local)
  ...
  - [Manual Provisioning](#manual-provisioning)
    ...
    - [Validate](#validate)
- [Automating the Project with Infrastructure As A Code (IAAC)](#automating-the-project-with-infrastructure-as-a-code-iaac)
...
# Automating the Project with Infrastructure As A Code (IAAC)

-   `vim automated_provisioning/Vagrantfile`
-   ```
    Vagrant.configure("2") do |config|
      config.hostmanager.enabled = true
      config.hostmanager.manage_host = true
