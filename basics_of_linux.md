...
This concludes the **Basics of Linux section**, and now you can proceed to learn some advanced concepts of Linux in other sections.
If you want to prepare for **Redhat Certified System Admin (RHCSA)** exam, refer to the [RH124](https://github.com/CoderChirag/DevOps-Learning/blob/linux/RH124.md) and [RH134](https://github.com/CoderChirag/DevOps-Learning/blob/linux/RH134.md) sections.
